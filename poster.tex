...
%----------------------------------------------------------------------------------------------------
\headerbox{Loop Iterations}{name=BoxFour, column=1, span=2}{
  \begin{tabular}{cp{\linewidth-\graphWidth}}
    \includegraphics[width=\graphWidth]{graph_one} &
...
%----------------------------------------------------------------------------------------------------
\headerbox{Function Complexity}{name=BoxFive, column=1, below=BoxFour, above=BoxThree, span=2}{
  \begin{tabular}{p{.95\linewidth-\graphWidth}l}
    &
